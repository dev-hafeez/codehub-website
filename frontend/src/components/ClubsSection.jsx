...
import circleImage from "../assets/circle1.png"; // Assuming this is used elsewhere or might be used later
...
const ClubsSection = () => {
  return (
    <div className="clubs-container container-fluid position-relative">
      ...
      {/* Center Circle */}
      <div className="center-circle text-center d-flex align-items-center justify-content-center" style={{backgroundColor:"#0c4182;"}}>
        CLUBS
      </div>
