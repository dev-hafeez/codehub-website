// // src/components/TrackMembersPage.jsx
// import React, { useEffect, useState } from "react";
// import Navbar from "../components/Navbar";
// import axiosInstance from "../axios";
// // Import the new CSS file
// import "../styles/TrackMemberPage.css";

// // Helper function to get a CSS class for the role badge
              ...
              {members.map((member) => (
                <tr key={member.user.id}>
                  ...
                  <td className="actions-cell">
                    ...
                    <button className="action-btn btn-edit" onClick={() => handleEdit(member)} title="Edit Member">
                      <FaEdit />
                    </button>
                  </td>
                </tr>
