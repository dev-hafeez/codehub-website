...
import eventImage from '../src/assets/events.jpg';
import eventsHeading from '../src/assets/Events.png';
import ellipseImage from '../src/assets/ellipse.png';
    ...
    <section className="py-5 bg-light position-relative events-section">
      ...
      <div className="container-fluid px-5 position-relative z-1">
        <img
          src={eventsHeading}
          alt="Events Heading"
          className="mx-auto d-block heading-img img-fluid"
        />
